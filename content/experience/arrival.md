## 抵达伦敦后的第一步 (First Steps After Arriving in London)

顺利抵达伦敦并完成最初的几项关键步骤，将为你的留学生活开启一个良好的开端。本章将指导你完成入境、从机场到市区以及初步报到注册等事宜。
...
- 伦敦地铁 (London Underground - Tube)：
  ...
  - **班次：** 高峰期约每5-10分钟一班。
  - **费用：** 使用Oyster卡或Contactless银行卡支付，单程票价约5.50英镑起（取决于目的地所在区域）26。
...
- 码头区轻轨 (Docklands Light Railway - DLR)：
  ...
  - **用时：** 到达Bank站约23分钟 34。
  - **费用：** 使用Oyster卡或Contactless银行卡支付，票价约2-4英镑 34。
- **公交车 (Buses)：** 有本地公交线路服务机场，但前往市中心通常需要换乘，用时较长 34。
- **出租车/网约车：** 前往市中心约27分钟，费用约40-50英镑 34。
...
- **生物信息居留许可 (Biometric Residence Permit - BRP) / 电子签证 (eVisa)：**
  - **背景与变迁：** 以往，在英国境外申请学生签证成功的学生，护照上会获得一个有效期90天的入境签证页 (vignette)，用于首次进入英国。完整的签证信息和有效期则记录在一张名为BRP的卡片上，学生需在抵英后规定时间内领取 36。然而，自2024年底起，UKVI逐步以eVisa（电子签证）取代实体BRP卡 22。这意味着你的移民身份将以数字形式记录在你的UKVI在线账户中。
  - 如果你被签发了BRP卡（主要适用于2024年底前获签的学生）：
    - **领取时间：** 必须在抵达英国后的10天内，或在护照上签证页失效前（以较晚者为准）领取 36。
    - **领取地点：** 你的签证获批信上会指明BRP卡的领取地点。通常是指定的邮局 (Post Office)，或者如果你在申请签证时填写了学校的ACL (Alternative Collection Location)代码（例如，伦敦卫生与热带医学院LSHTM的代码是2HE967），则可以在学校领取 37。
    - **领取凭证：** 携带你的护照原件和签证获批信 37。
    - **核对信息：** 领取BRP卡后，务必当场仔细核对卡上的所有信息是否准确无误，包括姓名拼写、出生日期、签证类型（应为“Student Visa”）、有效期（通常为你课程结束日期后额外加4个月）等 36。如发现任何错误，必须在10天内向英国内政部 (Home Office) 报告 37。
    - **BRP卡遗失或被盗：** 立即向警方和内政部报告。在英国境内和境外补办的流程不同 37。
  - 如果你持有eVisa（主要适用于2024年底后获签或BRP卡已更新至eVisa的学生）：
    - 你需要创建或登录你的UKVI在线账户，以查看你的eVisa详细信息，并生成“分享码”(share code) 用于向学校或雇主证明你的学习权或工作权 38。
...
- **大学报到与注册 (University Registration/Enrolment)：**
  - **联系家人：** 抵达住处后，第一件事是向家人报平安 38。
  - **入住手续：** 尽快办理宿舍或私人公寓的入住手续 38。
  - **学权检查 (Right to Study Check)：** 这是非英国/爱尔兰籍学生在完成在线注册前必须通过的环节。学校会通过邮件发送个性化链接。你需要提供eVisa分享码或BRP卡信息。对于学生签证持有者，此检查必须在你抵达英国后才能完成 38。及时完成此检查对于顺利开始学业至关重要，否则可能影响你正常上课或使用学校设施。
  - **在线注册/报到 (Online Enrolment/Registration)：** 大多数英国大学都采用在线注册系统。你需要在学校规定的时间内，登录学生系统，核对或填写个人信息、课程信息，并上传所需文件（如护照、签证扫描件等）。完成在线注册才算正式成为该校学生，之后才能获取课程表、学生邮箱、图书馆权限等 25。
